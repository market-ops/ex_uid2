defmodule ExUid2.Encryption.MasterPayload do
  ...
  def parse_v2(
        <<expires_ms::big-integer-64, site_key_id::big-integer-32, site_iv::big-binary-size(16),
          site_payload::binary>>
      ) do
    {
      :ok,
  ...
  def parse_v3(
        <<expires_ms::big-integer-64, _generated_ms::big-integer-64,
          ...
          site_key_id::big-integer-32, site_payload::binary>>
      ) do
    {:ok,
     %__MODULE__{
       version: 3,
  ...
  defp make_envelope(%__MODULE__{
    ...
    <<expires_ms::big-integer-64, 0::168, site_key_id::big-integer-32, site_payload::binary>>
  end
end
