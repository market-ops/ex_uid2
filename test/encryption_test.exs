defmodule Test.Encryption do
  ...
  test "V2 Tokens can be decrypted" do
    ...
    {:ok, %ExUid2.Uid2{uid: uid}} = Encryption.decrypt_v2_token(token, keyring)
  ...
  test "Tokens that are urlsafe base64 encoded can be decoded" do
    ...
    expected_decrypted_token = Encryption.decrypt_v2_token(token, keyring)
    ...
    decrypted_token = Encryption.decrypt_v2_token(url_safe_token, keyring)
